...
markings","fancy","https://upload.wikimedia.org/wikipedia/commons/a/a7/Nemecky_oborovity_strakos.jpg");

insert into entries (name, size, fur_type, ear_type, origin, colour, uses, url)
values
("Chinchilla(Standard)","Any","short","upright","France","Chinchilla","fancy","https://upload.wikimedia.org/wikipedia/commons/f/f1/Kaninchen3.jpg");
